const BASE_URL = 'https://meta-ads.hellenicai.com';

// HellenicAI logo SVG (white fill for dark backgrounds)
...
<title>HellenicAI Meta Ads MCP &mdash; by HellenicAI</title>
...
<div class="container">
  ...
  <div class="cta-row">
    ...
    <a href="https://github.com/serkanhaslak/meta-ads-mcp" class="btn btn-ghost" target="_blank">
    ...
    <pre><code><span class="comment">// .mcp.json</span>
{
  <span class="str">"mcpServers"</span>: {
    <span class="str">"meta-ads-mcp"</span>: {
  ...
  <div class="footer">
    ...
    <div class="footer-links">
      <a href="/docs">API Docs</a> &nbsp;&middot;&nbsp; <a href="/docs/json">OpenAPI Spec</a> &nbsp;&middot;&nbsp; <a href="https://github.com/serkanhaslak/meta-ads-mcp" target="_blank">GitHub</a>
    </div>
  </div>
